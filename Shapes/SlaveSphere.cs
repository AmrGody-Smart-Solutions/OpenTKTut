...
{
    class SlaveSphere : OGLShape
    {
        public SlaveSphere(OGLShape master, double radius, float distance,bool AutoRotate = false)
        {
            Master = master;
            Vector3 distance_3 = new Vector3(distance, distance,0.0f);
            Center = master.Center+distance_3;
            Radius = radius;
            EnableMasterRotate = true;
